...
model_dir = os.getenv("MODEL_DIR","yolo11m.engine")
IOT_URL = os.getenv("IOT_URL", "http://fiware-iot-agent:7896/iot/json")
IOT_KEY = os.getenv("IOT_KEY", "12345")
